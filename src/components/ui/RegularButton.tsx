...
const RegularButton = (props: ButtonProps) => {
    ...
    const colorClass =
        type === "primary"
            ? `px-2 py-1.5 shadow-sm border border-transparent text-white bg-brand-700 hover:bg-brand-900 focus:ring-0 focus:ring-offset-0 focus:ring-brand-500`
            : "px-2 py-1.5 shadow-sm border dark:border-gray-600 dark:text-gray-300 bg-gray-100 hover:bg-gray-200 dark:bg-gray-600 dark:hover:bg-gray-500 focus:ring-0 focus:ring-offset-0 focus:ring-gray-500";
